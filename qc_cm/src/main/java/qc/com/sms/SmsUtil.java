...
public class SmsUtil {
	 ...
	 * @param lstContent
	 */
	public static void sendSms(List<String> lstPhone, List<String> lstContent) {
	 ...
	 * @param strContent
	 */
	public static void sendSms(final String strPhone, final String strContent) {
		final Client client = new Client(sn, password);
		if (StringUtil.isEmpty(strPhone)) {
			return;
		}
		//发送个性短信
		//2014-03-24 Jack.Zhang 修改
	 ...
	 * @param lstContent
	 */
	public static void sendSms(List<String> lstPhone, String strContent) {
		Client client = new Client(sn, password);
		if (StringUtil.isEmptyList(lstPhone)) {
			return;
		}
