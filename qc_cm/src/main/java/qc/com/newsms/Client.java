...
public class Client {
	...
	private String serviceURL =SmsConf.getInstance().getServiceURL();//"http://sdk2.zucp.net:8060/webservice.asmx";

	private String sn = SmsConf.getInstance().getSn();//"SDK-WSS-010-05777";// 序列号
	private String password = SmsConf.getInstance().getPassword();//"f2c$b-9$";
	...
	public String register(String province, String city, String trade,
			...
			String email, String fax, String address, String postcode,String sign) throws Exception{
		String result = "";
	 ...
	 * 返 回 值：操作结果（String）
	 */
	public String chargeFee(String cardno, String cardpwd)  throws Exception{
		String result = "";
	...
	public String mt(String mobile, String content, String ext, String stime,
		...
		logger.debug("SMS Return:" + result);
		return result;
	}
 ...
 * 方法名称：gxmt 功 能：发送个性短信 ，即给不同的手机号发送不同的内容，手机号和内容用英文的逗号对应好
	 ...
	 * 返 回 值：操作结果（String）
	 */
	public String UDPPwd(String newPwd)  throws Exception{
		String result = "";
